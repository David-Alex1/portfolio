  ...
  return (
    <div className="text-white/80 flex-col flex gap-y-2 ">
      <p className="mt-5">
        ...
        graduating in May 2025, with a strong focus on intelligent automation
        and robotic systems integration. My academic and project experience
        spans industrial robotics, kinematics, human-robot interaction, and
        multi-robot simulation, using tools like RobotStudio, CoppeliaSim,
        MATLAB, and Python.
      </p>
      <p>
